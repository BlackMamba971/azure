    ...
    <div class="menu-container2">
        ...
        <div class="menu-toggle" id="menu-toggle">
            ...
            <ul class="menu">
                ...
                <li>
                    <button type="button" onclick="window.location.href ='/View/Entreprise/View<?php echo $_SESSION['role'] ?>Entreprise.php'" name="entreprise" value="Entreprise" class="btnCreation">Entreprise</button>
                    <button type="button" onclick="window.location.href ='/View/Entreprise/ViewAjoutEntreprise.php'" name="entreprise" value="Entreprise" class="sousBtnCreation">Créer une entreprise</button>
                    <button type="button" onclick="window.location.href ='/View/Entreprise/View<?php echo $_SESSION['role'] ?>Entreprise.php'" name="entreprise" value="Entreprise" class="sousBtnCreation">Rechercher une entreprise</button>
                    <button type="button" onclick="window.location.href ='/View/Offre/ViewAjoutOffre.php'" name="Offre" value="Offre" class="sousBtnCreation">Créer une offre</button>
                    <button type="button" onclick="window.location.href ='/View/Entreprise/View<?php echo $_SESSION['role'] ?>Entreprise.php'" name="Offre" value="Offre" class="sousBtnCreation">Rechercher une offre</button>
